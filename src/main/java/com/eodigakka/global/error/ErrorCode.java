...
public enum ErrorCode {
  ...
  GUEST_SESSION_INVALID(HttpStatus.UNAUTHORIZED, "GUEST_SESSION_INVALID", "게스트 세션이 올바르지 않습니다."),
  GUEST_SESSION_EXPIRED(HttpStatus.UNAUTHORIZED, "GUEST_SESSION_EXPIRED", "게스트 세션이 만료되었습니다."),
